...
public class SubidaFTP {
    ...
    private static final String LOCAL_FILE_PATH  = "src/main/resources/ftp/fichero.txt";
    private static final String REMOTE_FILE_PATH  = "/comoquiera.txt";

    public static void main(String[] args) {
        String servidor = "ftp.drivehq.com"; // Cambia esto por tu servidor FTP
